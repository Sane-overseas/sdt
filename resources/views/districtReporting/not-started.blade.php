<div class="v-container mt-2">
    <div class="row margin-tb">
        <div class="col-md-10">
            <h2 class="heading ">Not Starded Schools</h2>
        </div>
        <div class="col-md-2">
    ...
    @endif
    <div class="card-body">
        <table class="table table-bordered" id="notstardedDist">
            <thead>
                <tr>
                    <th>#</th>
                    <th>Trainer</th>
            ...
            <tbody>
                @foreach($not_startde_schools as $school)
                    <tr>
