                            ...
                            <div class="file-row">
                                <span class="file-side">
                                    ...
                                    @if($data['completion_file'])
                                        <a href="{{ media_url('completion', $data['completion_file']) }}" target="_blank" class="file-link complete-data">View</a>
                                        @if($data['status'] == 0)
...
(function () {
    ...
    var trainerCompletions = $table.DataTable({
        ...
        stateSave: true,
        autoWidth: false,
        buttons: [uploadedDataExcelButton($table, 'trainer-completions')]
    });
