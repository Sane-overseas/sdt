@extends('layouts.app')
@section('title', 'Emergency Approved UC')   
@section('content')
<style type="text/css">
   
    div#emergencyApprovedUC_info {
        margin-left: 35px;
        padding: 0px;
    }  
</style>
<div class="container">
    <div class="row">
        <div class="col-lg-10 margin-tb">
            <h2 class="heading">Emergency Approved UC</h2>
        </div>
    </div>
    <div class="card-body">
         <table class="table table-striped table-bordered" cellspacing="0" width="100%" id="emergencyApprovedUC">
            <thead>
                <tr>
                    <th>Trainer</th>
                    <th>Uploaded By</th>
...
<script type="text/javascript">
 const emergencyApprovedUC =   $('#emergencyApprovedUC').DataTable( {
    ordering: false,
...
$('#emergencyApprovedUC tfoot th').each( function () {
    var title = $(this).text();
...
// Apply the search
emergencyApprovedUC.columns().every( function () {
    var that = this;
