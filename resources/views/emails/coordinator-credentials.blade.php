...
<head>
    <meta charset="utf-8">
    <title>Coordinator Credentials</title>
</head>
<body style="font-family: Arial, sans-serif; color: #222; line-height: 1.5;">
    <p>Dear {{ $coordinatorName }},</p>

    <p>Your coordinator account has been created by the admin. You can now log in with the credentials below:</p>
    ...
    <table cellpadding="8" cellspacing="0" style="border-collapse: collapse; margin: 16px 0;">
        ...
        <tr>
            <td style="font-weight: bold;">Coordinator Code</td>
            <td>{{ $coordinatorCode }}</td>
        </tr>
        <tr>
